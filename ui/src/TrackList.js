...
/* const TrackList = ({ tracks, title, onRemove, isEditing }) => {
    ...
    const handleMore = (trackId) => {
        // Toggle the visibility of the remove button when clicking the "..." button
                    ...
                    <div className="track-preview" key={`${track._track_id}_${index}`}>
                        ...
                        {isEditing && (
                            <div className="action-buttons">
                                <button onClick={() => handleMore(track._track_id)}>...</button>
                                {showRemoveButton && trackToRemove === track._track_id && (
